            ...
            <table class="table repair-orders-table">
                ...
                <tbody>
                    ...
                    <?php foreach ($repair_orders as $or): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button
                                    ...
                                    data-bs-target="#editRepairOrderModal<?php echo $or['id']; ?>">
                                    Editar
                                </button>
                                ...
                                <button
                                    ...
                                    data-bs-toggle="modal"
                                    data-bs-target="#deleteRepairOrderModal<?php echo $or['id']; ?>">
                                    Eliminar
                                </button>
                            </td>
                        ...
                        <?php include 'edit_repair_order_modal.php'; ?>
                        <?php include 'delete_repair_order_modal.php'; ?>
